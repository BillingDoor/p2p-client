...
class TestPeers(unittest.TestCase):
    def test_equality(self):
        p1 = python.P2P.peer.Peer("127.0.0.1", 22, 12)
        p2 = python.P2P.peer.Peer("127.0.0.1", 22, 12)
        p3 = python.P2P.peer.Peer("127.1.0.1", 22, 12)
...
class TestMessaging(unittest.TestCase):
    ...
    def test_find_node(self):
        ...
        b_l.insert(python.P2P.peer.Peer("127.11.11.1", 1, 0b01010101))
        b_l.insert(python.P2P.peer.Peer("127.66.1.1", 33, 0b00110101))
        b_l.insert(python.P2P.peer.Peer("127.0.9.1", 22, 0b00100101))
        b_l.insert(python.P2P.peer.Peer("127.3.0.1", 5252523, 0b01010111))
        b_l.insert(python.P2P.peer.Peer("125.0.0.1", 434, 0b10110101))
        b_l.insert(python.P2P.peer.Peer("127.55.0.1", 2235, 0b00111101))
        b_l.insert(python.P2P.peer.Peer("127.0.23.1", 123, 0b00011101))
        test_node.routing_table = b_l

        test_peer = python.P2P.peer.Peer("127.0.0.1", 8081, 12)
        ...
        self.assertIn(python.P2P.peer.Peer("127.0.23.1", 123, 0b00011101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.66.1.1", 33, 0b00110101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.0.9.1", 22, 0b00100101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.55.0.1", 2235, 0b00111101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.66.1.1", 33, 0b00110101), nodes)
    ...
    def test_bootstraping(self):
        ...
        self.assertIn(python.P2P.peer.Peer("127.0.0.1", 9081, 12), k1.routing_table)
...
class TestBucketList(unittest.TestCase):
    ...
    def test_contains(self):
        ...
        self.assertIn(python.P2P.peer.Peer("127.0.9.1", 22, 0b00100101), b_l)
    ...
    def test_nearest_nodes(self):
        b_l = python.P2P.BucketList.BucketList(15, 10, 0)
        key_peer = python.P2P.peer.Peer("127.0.0.1", 33, 0b00010101)
        b_l.insert(key_peer)

        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b01010101))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b00110101))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b00100101))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b01010111))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b10110101))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b00111101))
        b_l.insert(python.P2P.peer.Peer("127.0.0.1", 33, 0b00011101))

        nodes = b_l.nearest_nodes(key_peer.id, 1)
        self.assertEqual(nodes[0], python.P2P.peer.Peer("127.0.0.1", 33, 0b00010101))

        nodes = b_l.nearest_nodes(key_peer.id, 4)
        self.assertIn(python.P2P.peer.Peer("127.0.0.1", 33, 0b00010101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.0.0.1", 33, 0b00110101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.0.0.1", 33, 0b00111101), nodes)
        self.assertIn(python.P2P.peer.Peer("127.0.0.1", 33, 0b00011101), nodes)
